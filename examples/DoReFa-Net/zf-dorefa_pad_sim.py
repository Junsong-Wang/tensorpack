...
To Run Pretrained Model:
    ./zf-dorefa_pad_sim.py --load alexnet-126.npy --run cat.jpg --dorefa 1,4,32
"""
...
def run_image(model, sess_init, inputs):
    pred_config = PredictConfig(
        ...
        output_var_names=['output', 'conv0/output:0', 'bn0/bn/add_1:0', 'div_1:0', 'pool0/MaxPool:0', 'conv1/output:0', 'bn1/bn/add_1:0', 'div_2:0', 'pool1/MaxPool:0', 'div_3:0', 'div_4:0', 'div_5:0', 'pool4/MaxPool', 'div_6:0', 'div_7:0', 'fct/output:0']
    )
    ...
    for f in inputs:
        ...
        img = np.round(img)
        data.mat_dump_hex('./dump/input_sim.dat', img)
        data.mat_dump_int('./dump/input.dat', img)
        outputs = predict_func([img])
        inter_layers = ['conv0', 'bn0', 'active0', 'pool0', 'conv1', 'bn1', 'active1', 'pool1', 'conv2', 'conv3', 'conv4', 'pool4', 'fc0', 'fc1', 'fct']
