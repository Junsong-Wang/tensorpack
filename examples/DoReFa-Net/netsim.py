...
from cnn_lib import conv, pool, data_dump, fc
...
if __name__ == '__main__':
    ...
    if compensation:
        weights = weights / compensation_factor['conv0/W:0']
    ...
    if compensation:
        weights = weights / compensation_factor['conv1/W:0']
    ...
    if compensation:
        weights = weights / compensation_factor['conv2/W:0']
    ...
    if compensation:
        weights = weights / compensation_factor['conv3/W:0']
    ...
    if compensation:
        weights = weights / compensation_factor['conv4/W:0']
    ...
    if compensation:
        weights = weights / compensation_factor['fc0/W:0']
    bn = [param_dict['bnfc0/mean/EMA:0'], param_dict['bnfc0/variance/EMA:0'], param_dict['bnfc0/gamma:0'], param_dict['bnfc0/beta:0']]
    fc0_output, fc0_output_fix = fc(pool4_output.astype(np.int32), weights, bn, 3, 3, True)
    if sim_fix:
    ...
    if compensation:
        weights = weights / compensation_factor['fc1/W:0']
