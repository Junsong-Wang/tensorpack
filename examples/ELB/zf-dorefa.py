...
To Run Pretrained Model:
    ./zf-dorefa_pad_64.py --load zf_pad_64.npy --run cat.jpg --dorefa 1,4,32
"""
...
class Model(ModelDesc):
    ...
    def _build_graph(self, input_vars, is_training):
        ...
        fw1, fw2, fw4, fw8, fa, fg = get_dorefa(BITW, BITA, BITG)
        ...
        def new_get_variable(name, shape=None, **kwargs):
            ...
            if name == 'W' and ('conv0' in v.op.name):
                ...
                logger.info("No Binarizing weight {}".format(v.op.name))
                return v
        ...
        with argscope(BatchNorm, decay=0.9, epsilon=1e-4, use_local_stat=is_training), \
            ...
            logits = (LinearWrap(image)
                .Conv2D('conv0', 96, 7, stride=2, padding='SAME')
                .apply(fg)
                .BatchNorm('bn0')
